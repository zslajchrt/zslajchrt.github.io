...
1. Stability: The character or meaning of domain entities is more stable than the structure
...
2. Type safety: The type system verifies the consistency of the mapping rules,
...
3. Early error discovery: If a static language is used then the consistency
